...
@Component({
  selector: 'app-superadmin-clockin',
  standalone: false,
  templateUrl: './superadmin-clockin.component.html',
  styleUrl: './superadmin-clockin.component.css'
})
export class SuperadminClockinComponent {
